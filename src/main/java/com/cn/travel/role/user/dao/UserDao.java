...
public interface UserDao extends BaseDao<User> {
    ...
    //    家长
    @SelectProvider(type = UserSqlProvider.class, method = "findListOwers")
    List<User> findListOwers();

//    有效的家长
    @SelectProvider(type = UserSqlProvider.class, method = "findListOwerState")
    List<User> findListOwerState();

//    成员
    @SelectProvider(type = UserSqlProvider.class, method = "findListMembers")
    List<User> findListMembers();
}
